...
function mostrarSugestoes() {
    ...
    const searchBar = inputElement.parentElement; // Define a barra de pesquisa como o elemento pai do input
    const input = removerAcentos(inputElement.value.toLowerCase());

    suggestionsContainer.innerHTML = "";

    const resultados = listaAnimaisSugestoes.filter(animal =>
